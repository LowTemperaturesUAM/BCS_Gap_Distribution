...
Fig1 = figure(567);
       ...
       Sub1 = subplot(1,3,1,'Parent',Fig1);
           Sub1_h1 = plot(Delta,Gamma,'-','LineWidth',2,'Color',[0 0.4470 0.7410]);
               Sub1_h1.Parent = Sub1;
    ...
    Sub3 = subplot(1,3,3,'Parent',Fig1);
        ...
        xlabel(Sub3,'Energy (meV)','FontSize',TamahoFuenteTitulos);
...
% Saving data
% -----------------------------------------------------------------------
    dlmwrite('NormalizedBCSDOS.txt', [Energia,Conductancia],'delimiter','\t','newline','pc');
